              ...
              <div className="mt-6">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white bg-gray-400 text-sm font-medium text-gray-500 hover:bg-gray-400 transition-colors"
                  >
